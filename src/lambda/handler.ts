...
const roleRules: RoleRule[] = [
  ...
  { pattern: /^GET \/v1\/monitor\/social\/charts\/topic-breakdown$/, requiredRole: "SocialOverviewViewer" },
...
export const main = async (event: APIGatewayProxyEventV2) => {
  ...
  if (key === "GET /v1/monitor/social/charts/topic-breakdown") return getMonitorSocialTopicBreakdown(event);
